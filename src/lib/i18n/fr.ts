export default {
  ...
  //game's goal section
  transformYourEnergy:
    'Transformez votre énergie négative en énergie positive grâce au pouvoir des danses ancestrales maori !',
  ...
  adviceFormulaExplanationPart1: 'Cette formule vous permettra de réactiver votre',
